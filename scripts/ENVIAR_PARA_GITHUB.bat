...
echo === ENVIANDO RELEASE V0.2.43 PARA O GITHUB ===
echo.
...
git commit -m "release: v0.2.43 - correcoes de seguranca RLS, triggers multi-quartel e organizacao de pastas"

echo [3/6] Criando tag v0.2.43...
...
echo [6/6] Enviando tag v0.2.43 para o GitHub...
git push origin v0.2.43

echo.
echo === CONCLUIDO! O SISTEMA FOI ENVIADO COM SUCESSO AO GITHUB (RELEASE V0.2.43) ===
pause
