...
echo === ENVIANDO RELEASE V0.3.3 PARA O GITHUB ===
echo.
...
git commit -m "release: v0.3.3 - correcao pnpm ci workflow e versao pacote"

echo [3/6] Criando tag v0.3.3...
...
echo [6/6] Enviando tag v0.3.3 para o GitHub...
git push origin v0.3.3

echo.
echo === CONCLUIDO! O SISTEMA FOI ENVIADO COM SUCESSO AO GITHUB (RELEASE V0.3.3) ===
pause
