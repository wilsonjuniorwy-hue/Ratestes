...
echo === ENVIANDO RELEASE V0.3.6 PARA O GITHUB ===
echo.
...
git commit -m "release: v0.3.6 - restauracao de compatibilidade Windows Defender e integracao de ocorrencias"

echo [3/6] Criando tag v0.3.6...
...
echo [6/6] Enviando tag v0.3.6 para o GitHub...
git push origin v0.3.6

echo.
echo === CONCLUIDO! O SISTEMA FOI ENVIADO COM SUCESSO AO GITHUB (RELEASE V0.3.6) ===
pause
