...
echo === ENVIANDO RELEASE V0.2.26 PARA O GITHUB ===
echo.
...
"%GIT%" commit -m "release: v0.2.26 - cadastro em lote de bastoes, radios e coletes no RPMon"

echo [3/5] Criando tag v0.2.26...
"%GIT%" tag v0.2.26

echo [4/5] Enviando codigo para o GitHub (branch main)...
"%GIT%" push origin main

echo [5/5] Enviando tag v0.2.26 para disparar o atualizador...
