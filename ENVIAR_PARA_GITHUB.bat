...
echo === ENVIANDO RELEASE V0.2.39 PARA O GITHUB ===
echo.
...
git commit -m "release: v0.2.39 - exibicao completa de cautelas ativas sem filtro restritivo de quartel e busca insensivel no RTM"
