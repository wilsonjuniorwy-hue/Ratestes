...
echo === ENVIANDO RELEASE V0.2.42 PARA O GITHUB ===
echo.
...
git commit -m "release: v0.2.42 - publicacao automatica de release e sincronizacao de versao"

echo [3/6] Criando tag v0.2.42...
...
echo [6/6] Enviando tag v0.2.42 para o GitHub...
git push origin v0.2.42

echo.
echo === CONCLUIDO! O SISTEMA FOI ENVIADO COM SUCESSO AO GITHUB (RELEASE V0.2.42) ===
pause
